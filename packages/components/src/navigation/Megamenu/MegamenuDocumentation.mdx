...
4. linkRenderer
5. menuData
6. menuData JSON Schema Validation
...
```json
{
  ...
  "onLanguageClick": (type) => console.log(`You selected ${type}`) /* called when a language is seleted */,
}
```

### 3. profileData Sample
...
### 6. menuData JSON Validation Schema
